...
- *Heroku backend does not work due to the backend taking about 2 minutes to process the image, time limit for heroku requests is 30 seconds This is mostly due to the long duration of performing OCR with cloud vision api.
...
#### Improvements
 ...
 ![alt text](https://github.com/AmruthHB/Word-Searcher/edit/main/image.jpg?raw=true)
